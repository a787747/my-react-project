...
**As of:** 2026-08-25 (PRELAUNCH_GUIDE_AND_ZONES) · **H1: active, not started**
...
| Frontend | This host. Current release **`20260825T065554Z`**. **22** releases on disk (previous: `20260824T182054Z`, `20260824T175642Z`, `20260824T145133Z`, `20260824T131920Z`, `20260824T061101Z`, …). Public `index.html` `Last-Modified` Tue, 25 Aug 2026 06:56:00 GMT. Deploy: `./scripts/deploy_epe_frontend.sh` |
...
- **Periods on live — three rows:**
  ...
  | 2 | H1-2026 | `half_year` | `active` | true | **5** | 0 | 89 / **87** |
