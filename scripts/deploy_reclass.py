#!/usr/bin/env python3
"""Validate or PUT the workflows changed by the 2026-08-24 reclassification brief.

Same contract as deploy_lifecycle_coeff.py:
...
TARGETS: dict[str, tuple[str, str, str]] = {
    ...
    "save-user.json":               ("h1",   "JCjzhRJtIDW0z8mI", "API_ Admin Save User (GUI Mode).json"),
    ...
    "evaluations-matrix.json":      ("def",  "yQNNr0i4UBFNVgMv", "API_ evaluations-matrix.json"),
